...
public class Main {
	...
	private static void inputNumber() {
		if (nonNull(board)) {
			...
			System.out.printf("Iforme o numero que será adicionado a posição [%s, %s]\n ", col, row);
	...
	private static void removeNumber() {
		...
		System.out.printf("Informe o numero que será adicionado a posição [%s, %s]\n ", col, row);
	...
	private static void showCurrentGame() {
		...
		System.out.println("Seu jogo no momento esta assim: ");
	...
	private static void finishGame() {
		...
		if (board.gameOver()) {
			...
			System.out.println("Seu jogo contem erros verifique seo board e ajuste-o!");
		} else {
			System.out.println("Confira se todos os espaços foram preenchidos!");
		}
	}
